/**
 * Browser client bundle for dsh-jailbreak-manager, mirroring the DeepSeek Harness
 * `clientBundle` protocol: CJS closure-factory artifact registered through
 * `window.__ModuleLoader__.load`, CSS Modules compiled by lightningcss, and
 * every other @deepseek-ai value import rejected (purity gate).
 */
